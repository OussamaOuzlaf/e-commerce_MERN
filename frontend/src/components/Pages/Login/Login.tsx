        ...
        <>
            <div className='container py-6'>
                ...
                <div className='flex flex-col gap-4 justify-center items-center'>
                    ...
                    <Link to='/'><button className='bg-blue-600 rounded p-2 text-white' onClick={onSubmit}>Login</button></Link>
                    <Link to="/Register">You Don't Have a Account?<span className='text-red-600'>Register Now</span></Link>
